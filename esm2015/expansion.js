...
import { CompatibilityModule, UNIQUE_SELECTION_DISPATCHER_PROVIDER, UniqueSelectionDispatcher, mixinDisabled } from '@angular/material/core';
 ...
 * \@docs-private
 */
class MdExpansionPanelBase extends AccordionItem {
    /**
     * @param {?} accordion
     * @param {?} _changeDetectorRef
...
const _MdExpansionPanelMixinBase = mixinDisabled(MdExpansionPanelBase);
/**
 ...
 */
class MdExpansionPanel extends _MdExpansionPanelMixinBase {
    /**
     * @param {?} accordion
     * @param {?} _changeDetectorRef
     * @param {?} _uniqueSelectionDispatcher
