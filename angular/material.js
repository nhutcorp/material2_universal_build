...
class MdCheckbox extends _MdCheckboxMixinBase {
    ...
    constructor(renderer, elementRef, _changeDetectorRef, _focusOriginMonitor) {
         ...
         */
        this.ariaLabelledby = null;
        this._uniqueId = `md-checkbox-${++nextUniqueId$3}`;
        /**
...
class MdTooltip {
    ...
    _createOverlay() {
        ...
        const /** @type {?} */ config = new OverlayState({
            direction: this._dir ? this._dir.value : 'ltr',
...
class MdRadioGroup extends _MdRadioGroupMixinBase {
    ...
    constructor(_changeDetector) {
         ...
         */
        this._name = `md-radio-group-${nextUniqueId$5++}`;
        /**
...
class MdRadioButton extends _MdRadioButtonMixinBase {
    ...
    constructor(radioGroup, elementRef, renderer, _changeDetector, _focusOriginMonitor, _radioDispatcher) {
        ...
        this._uniqueId = `md-radio-${++nextUniqueId$5}`;
        /**
...
const _MdSlideToggleMixinBase = mixinTabIndex(mixinColor(mixinDisableRipple(mixinDisabled(MdSlideToggleBase)), 'accent'));
/**
...
class MdSlideToggle extends _MdSlideToggleMixinBase {
    ...
    constructor(elementRef, renderer, _platform, _focusOriginMonitor, _changeDetectorRef, tabIndex) {
        ...
        this.onChange = (_) => { };
        this.onTouched = () => { };
        this._uniqueId = `md-slide-toggle-${++nextUniqueId$6}`;
        this._required = false;
        this._checked = false;
        /**
         * Name value will be applied to the input element if present
...
class MdSnackBarContainer extends BasePortalHost {
    ...
    _completeExit() {
        // Note: we shouldn't use `this` inside the zone callback,
        // because it can cause a memory leak.
        const /** @type {?} */ onExit = this._onExit;
        first.call(this._ngZone.onMicrotaskEmpty).subscribe(() => {
            onExit.next();
            onExit.complete();
        });
...
class MdSnackBar {
    ...
    openFromComponent(component, config) {
        const /** @type {?} */ _config = _applyConfigDefaults$1(config);
