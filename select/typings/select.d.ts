...
import { CanDisable, HasTabIndex, MdOptgroup, MdOption, MdOptionSelectionChange } from '@angular/material/core';
...
export declare const _MdSelectMixinBase: (new (...args: any[]) => HasTabIndex) & (new (...args: any[]) => CanDisable) & typeof MdSelectBase;
/**
 * Allows the user to customize the trigger that is displayed when the select has a value.
 */
export declare class MdSelectTrigger {
}
export declare class MdSelect extends _MdSelectMixinBase implements AfterContentInit, OnDestroy, OnInit, ControlValueAccessor, CanDisable, HasTabIndex, MdFormFieldControl<any> {
