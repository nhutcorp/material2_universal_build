...
(function (global, factory) {
	typeof exports === 'object' && typeof module !== 'undefined' ? factory(exports, require('@angular/core'), require('@angular/forms'), require('@angular/cdk/coercion'), require('@angular/platform-browser'), require('@angular/cdk/bidi'), require('rxjs/Subject'), require('@angular/common'), require('@angular/cdk/scrolling'), require('@angular/cdk/platform'), require('@angular/cdk/keycodes'), require('@angular/cdk/a11y')) :
	typeof define === 'function' && define.amd ? define(['exports', '@angular/core', '@angular/forms', '@angular/cdk/coercion', '@angular/platform-browser', '@angular/cdk/bidi', 'rxjs/Subject', '@angular/common', '@angular/cdk/scrolling', '@angular/cdk/platform', '@angular/cdk/keycodes', '@angular/cdk/a11y'], factory) :
	(factory((global.ng = global.ng || {}, global.ng.material = global.ng.material || {}, global.ng.material['button-toggle'] = global.ng.material['button-toggle'] || {}),global.ng.core,global.ng.forms,global.ng.cdk.coercion,global.ng.platformBrowser,global.ng.cdk.bidi,global.Rx,global.ng.common,global.ng.cdk.scrolling,global.ng.cdk.platform,global.ng.cdk.keycodes,global.ng.cdk.a11y));
}(this, (function (exports,_angular_core,_angular_forms,_angular_cdk_coercion,_angular_platformBrowser,_angular_cdk_bidi,rxjs_Subject,_angular_common,_angular_cdk_scrolling,_angular_cdk_platform,_angular_cdk_keycodes,_angular_cdk_a11y) { 'use strict';
...
var MdOption = (function () {
    ...
    function MdOption(_element, _changeDetectorRef, group) {
        ...
        this._id = "md-option-" + _uniqueIdCounter$1++;
        /**
...
MdButtonToggleModule.decorators = [
    { type: _angular_core.NgModule, args: [{
                imports: [MdCommonModule, _angular_cdk_a11y.A11yModule],
                exports: [
                    MdButtonToggleGroup,
