...
(function (global, factory) {
	typeof exports === 'object' && typeof module !== 'undefined' ? factory(exports, require('@angular/cdk/platform'), require('@angular/common'), require('@angular/core'), require('@angular/animations'), require('@angular/cdk/coercion'), require('@angular/cdk/rxjs'), require('@angular/platform-browser'), require('@angular/cdk/bidi'), require('rxjs/Subject'), require('@angular/cdk/scrolling'), require('@angular/cdk/keycodes'), require('rxjs/observable/fromEvent'), require('@angular/forms')) :
	typeof define === 'function' && define.amd ? define(['exports', '@angular/cdk/platform', '@angular/common', '@angular/core', '@angular/animations', '@angular/cdk/coercion', '@angular/cdk/rxjs', '@angular/platform-browser', '@angular/cdk/bidi', 'rxjs/Subject', '@angular/cdk/scrolling', '@angular/cdk/keycodes', 'rxjs/observable/fromEvent', '@angular/forms'], factory) :
	(factory((global.ng = global.ng || {}, global.ng.material = global.ng.material || {}, global.ng.material.input = global.ng.material.input || {}),global.ng.cdk.platform,global.ng.common,global.ng.core,global.ng.animations,global.ng.cdk.coercion,global.ng.cdk.rxjs,global.ng.platformBrowser,global.ng.cdk.bidi,global.Rx,global.ng.cdk.scrolling,global.ng.cdk.keycodes,global.Rx.Observable,global.ng.forms));
}(this, (function (exports,_angular_cdk_platform,_angular_common,_angular_core,_angular_animations,_angular_cdk_coercion,_angular_cdk_rxjs,_angular_platformBrowser,_angular_cdk_bidi,rxjs_Subject,_angular_cdk_scrolling,_angular_cdk_keycodes,rxjs_observable_fromEvent,_angular_forms) { 'use strict';
...
var MdInput = (function () {
    ...
    Object.defineProperty(MdInput.prototype, "shouldPlaceholderFloat", {
        /**
         * @return {?}
         */
     ...
     * @return {?}
     */
    MdInput.prototype.onContainerClick = function () { this.focus(); };
    return MdInput;
}());
MdInput.decorators = [
    { type: _angular_core.Directive, args: [{
